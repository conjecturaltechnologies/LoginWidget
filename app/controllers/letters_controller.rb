class LettersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      ...
      if @letter.save
        format.html { redirect_to(@letter, :notice => 'Thank you for submitting your letter.') }
  ...
  def update
    ...
    respond_to do |format| #this is a parameter, respond_to simple uses it if it finds it.
      if @letter.update_attributes(params[:letter])
        format.html { redirect_to(@letter, :notice => 'Letter updated.') }
        format.xml  { head :ok }
      else
